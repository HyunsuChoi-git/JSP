...
<head>
	...
	<script>
		...
		function confirmIdPopup(inputForm){	
			...
			var url = "/JSP/member/confirmId.win?id="+inputForm.id.value;
...
<body>
	...
	<form action="/JSP/member/signupPro.win" enctype="multipart/form-data" method="post" name="inputForm" >
	<table>
		<tr>
			<td>아이디 * </td>
